...
static void call_state_changed(LinphoneCore *lc, LinphoneCall *call, LinphoneCallState cstate, const char *msg) {
    switch (cstate) {
        ...
        case LinphoneCallConnected:
            ...
            linphone_core_set_play_file(lc, "/home/gaurav/linphone_project/src/call_record.wav");
            break;
...
int main(int argc, char *argv[]) {
    ...
    */
    ...
    linphone_core_set_sip_transports(lc, &(LinphoneSipTransports){ .udp_port = 5070, .tcp_port = -1, .tls_port = -1 });
